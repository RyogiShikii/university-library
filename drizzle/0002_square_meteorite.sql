...
ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_book_id_boos_id_fk" FOREIGN KEY ("book_id") REFERENCES "public"."boos"("id") ON DELETE no action ON UPDATE no action;